...
export default function Sintroduction() {
	return (
		<section
			...
			<div className="mt-40 bg-black bg-opacity-50 rounded-xl mr-10 ml-10">
				<div className="flex justify-center items-center">
					<h1 className="text-2xl lg:text-3xl p-10 font-extrabold">
				...
				<div className="grid grid-cols-1 xl:grid-cols-2 ">
					...
					<div className="flex flex-col items-start p-10">
						<p className="text-sm lg:text-xl mb-8">
							...
							<span className="text-2xl font-bold lg:text-4xl">&nbsp;멘티</span>
